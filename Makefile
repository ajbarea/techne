...
# stay out of validate. Every case loads stand-ins for the general document and catch-up
# skills techne shares a session with, so a collision shows up as a failed case.
